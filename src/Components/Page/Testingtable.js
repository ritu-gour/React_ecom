...
// import { Accordion, Button, Card, Col, Container, Form, Row, Stack } from "react-bootstrap";
// // import Testing from "./Testing";
// import 'react-calendar/dist/Calendar.css';
// const Testingtable = () => {
//     const [value1, setValue] = useState(new Date());
...
//                                     <div className="mt-3 form__field mb-4">
//                                         <p>Veuillez choisir l’heure et la date de votre livraison.
//                                             Vous devez être présent pour récupérer le colis.</p>
//                                     </div>
//                                     <Accordion defaultActiveKey="0">
//                                         <Accordion.Item eventKey="0">
//                                             <Accordion.Header>Date de naissance</Accordion.Header>
//                                             <Accordion.Body>
//                                                 <Form.Group className="mb-3" controlId="formBasicEmail">
//                                                     <Form.Label className="text-white"></Form.Label>
//                                                     <Form.Control className="FormControl2 bnm78" type="text" value={value.toDateString()} required />
...
//                                         <br></br>
//                                         <Accordion.Item eventKey="0">
//                                             <Accordion.Header>Heure de la livraison</Accordion.Header>
//                                             <Accordion.Body>
//                                                 <div className='getminuts'>
//                                                     <Stack direction="horizontal" gap={3} >
//                                                         <div className="p mb-3"> <p><span className='gethour'> {value1.getHours()} </span> <span style={{ fontSize: "50px", marginLeft: "10px" }}> : </span>
//                                                             <span className='gethour1'>{value1.getMinutes()}</span>

//                                                         </p></div>
//                                                         <div className="p "><span className='gethour9'>Matin </span><br></br><span className='gethour99'>Soir</span></div>
...
//                                     </Accordion>
//                                     <div className='my-3'>
//                                         <p>Votre livraison aura lieu mardi 17 octobre 2023 à 7h00.</p>
//                                         <p>En cas d’absence, la seconde livraison sera à votre charge.</p>
//                                     </div>
