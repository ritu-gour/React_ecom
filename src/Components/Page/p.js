...
import { Accordion, Container, Stack, Button, Row, Col, Card } from 'react-bootstrap';
  ...
  return (
    <div>
      ...
      >
        ...
        <Steps.Step title='Finish' icon={<FaCheck />} />
              ...
              <Row>
                ...
                <Col sm={12}>
                  ...
                  <Form >
                    ...
                    <div className='marinputs'>
                      <Button htmlType='submit' className='SUIVANT' name='submit'>PROCÉDER AU PAIEMENT</Button>
                    </div>
