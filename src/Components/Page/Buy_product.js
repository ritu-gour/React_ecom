...
const Buy_product = () => {
    ...
    const [itemsPerPage, setItemsPerPage] = useState(8); // Number of cards per page
        ...
        <div>
            <div className="new-wrapper">
                ...
                <Container>
                    ...
                    <div className='marg97' style={{ background: "#EAEAEA" }}>
                        <Stack direction="horizontal" gap={3} className='row56'>

                            <div className="p-2 connector">  <h2 className='commen mb-4'>Par produit</h2></div>
                            <div className="p-2 ">
                        ...
                        <Row >
                            ...
                            <Col sm={3} className='my-2'><p><b style={{ fontWeight: "700" }}>Prix :  </b> 0 - 30€ <IoIosClose /></p></Col>
                            <Col sm={5} className='my-2'><p><b style={{ fontWeight: "700" }}>Labels :  </b>Recyclé <IoIosClose /></p></Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col sm={10} className='my-2'><p><b style={{ fontWeight: "700" }}>Lieu :</b> Paris (tous arrondissements) <IoIosClose /></p></Col>
                        ...
                        <Row className='mbnvc my-5 row09 leftimgeh89'>
                                ...
                                return (
                                    <Col key={value.id} sm={4} >
                                        <Card className='cardheig' style={{ border: "none", borderRadius: "0px", marginBottom: "20px" }}>
                                            <Card.Img variant="top" src='./img/meile11.jpeg' className='cardimgtop' />
                                            <Card.Body>

                                                <p style={{ color: "#084442 " }}>Marmelade  <b style={{ float: "right" }}>{value.price}€</b></p>

                                                <p className='mb-4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspend varius enim.</p>

                                                <Stack direction="horizontal" gap={3} className='vectimngf'>
                                                    <div className="p ">

                                                        <p className=''>Chez Jean et Louis <br></br><FaMapMarkerAlt style={{ color: "#084442" }} /> Paris 13</p></div>

                                                    <div className="p leftimgeh">
                                                        <img src='./img/Vector.png' width={20} /> <img src='./img/Bia.png' width={20} />
                                                    </div>
                                                ...
                                                <Button className='RECHERCHER117 my-4'>VOIR L’ARTICLE</Button>
